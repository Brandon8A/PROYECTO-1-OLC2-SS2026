...
public class ZetarianoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "PUBLIC", "CLASS", "STRING", "INT", "VOID", "RETURN", "BOOLEAN", 
			"IF", "NULL", "DOUBLE", "CHAR", "TRUE", "FALSE", "NEW", "ELSE", "SWITCH", 
			"CASE", "DEFAULT", "BREAK", "FOR", "CONTINUE", "WHILE", "DO", "PRINTLN", 
			"PRINT", "READLN", "ASIGNACION", "ASIGNACION_SUMA", "ASIGNACION_RESTA", 
			"ASIGNACION_MULT", "SUMA", "RESTA", "MULTIPLICACION", "DIVISION", "MODULO", 
			"IGUALDAD", "DESIGUALDAD", "MENOR_QUE", "MAYOR_QUE", "MAYOR_IGUAL_QUE", 
			"MENOR_IGUAL_QUE", "NEGACION", "TERNARIO", "AND", "OR", "INCREMENTO", 
			"DECREMENTO", "ID", "DECIMAL", "ENTERO", "CARACTER", "CADENA", "ESPACIO", 
