...
public class PigLatinLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "FINIS_PRINCIPAL", "NUMERUS", "TEXTUM", "DECIMALIS", 
			"LITTERA", "ESTO", "SERIES", "VERUM", "FALSUS", "STRUCTURA", "SI", "FINIS", 
			"ALITER", "DUM", "FACERE", "PER", "ACTIO", "VARIABILES", "MUNERA", "MAIOR", 
			"RATIO", "REDDERE", "NEGACION", "BOOL", "PERGE", "INTERRUMPE", "NOVUS", 
			"IMPORT", "SUMA", "RESTA", "MULTIPLICACION", "DIVISION", "LEER_TEXTO", 
			"IMPRIMIR_TEXTO", "IGUALDAD", "DESIGUALDAD", "MENOR_QUE", "MAYOR_QUE", 
			"MAYOR_IGUAL_QUE", "MENOR_IGUAL_QUE", "ASIGNACION", "AND", "OR", "SUMA_ABREVIADA", 
			"RESTA_ABREVIADA", "ID", "DECIMAL", "ENTERO", "CARACTER", "CADENA", "ESPACIO", 
